 ...
 */
void SendMessage(char* receiverId, char* sndMsg, void** buffer);    ////

/*
 * Delay requesting process until a message arrives in the process's queue
 */
void WaitMessage(char* senderId, char* recMsg, void** buffer);    ////

/*
 * Copy an answer in which message has been received (the identity in charge...)
 */
void SendAnswer(int* result, char* ansMsg, void* buffer);              ////

/*
 * Delays the requesting process until answer arrives in a given buffer (hence, send message need to know the 
 * identity of message buffer where the message was sent, so that it know where to wait on)
 */

void WaitAnswer(int* result, char* ansMsg, void* buffer);             ////
